  ...
  if (!Array.isArray(tickets) || tickets.length === 0) {
    ...
    results.innerHTML = `
      <div class="card empty-state">
        ...
        <p>
          Make sure the email and phone number match
          the information used when the ticket was submitted.
        </p>
      </div>
    `;
...
/* =========================================================
   ...
   SECURITY:
   Engineer key is sent through HTTP header,
   NOT URL query string.
   ========================================================= */
